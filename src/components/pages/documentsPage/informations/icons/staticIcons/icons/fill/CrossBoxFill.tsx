const CrossBoxFill = () => {
    return (
        ...
        >
            ...
            {/* <path 
                d="M 12 25 C 12 18 18 12 25 12 L 75 12 C 82 12 88 18 88 25 L 88 75 C 88 82 82 88 75 88 L 25 88 C 18 88 12 82 12 75 L 12 25 
                M 33.1 36.7 L 46.4 50 L 33 63 C 30.9 65.8 34.3 68.7 36.6 67 L 50 53.5 L 62.9 66.4 C 65.7 69.3 69.4 65.8 66.6 63 L 53.5 50 
                L 66.8 36.8 C 69.3 34.5 65.4 30.8 63.1 33.4 L 50 46.5 L 36.7 33.1 c -2.6 -2.2 -5.6 0.9 -3.7 3.4"
                fill="currentColor"
                stroke="transparent"
                strokeWidth="0"
                strokeLinecap="round"
