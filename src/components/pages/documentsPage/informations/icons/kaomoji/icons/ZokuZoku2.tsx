...
const ZokuZoku2 = () => {
    ...
    return (
        <svg viewBox="2 39 82 20" xmlns="http://www.w3.org/2000/svg"  height="1em" width="4.1em">
            {creatMonsterTeam({patternMap: patternMap, teamStartPosition: 0.5})}
        </svg>
    )
}
export default ZokuZoku2;