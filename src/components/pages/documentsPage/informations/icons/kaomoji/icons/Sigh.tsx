    ...
    return (
        <svg viewBox="0 39 60 20" xmlns="http://www.w3.org/2000/svg" height="1em" width="3em">
            ...
            <motion.path 
                ...
                strokeLinecap="butt"
                strokeLinejoin="miter"
                initial={{d: "M 14 50 l 5 0 m 12 0 l 5 0 m -15 -4 l 0 8 m 1 3 l 9 0"}}
                animate={{d: "M 13 50 l 5 0 m 12 0 l 5 0 m -15 -4 l 0 8 m 1 3 l 9 0"}}
            ...
            {/* eyebrow 2*/}
            <path 
                d="M 42 39 l 2 0 l 1 2 l -1 0 l -2 -2"
                fill="currentColor"
                stroke="transparent"
                strokeWidth="0"
                strokeLinecap="round"
