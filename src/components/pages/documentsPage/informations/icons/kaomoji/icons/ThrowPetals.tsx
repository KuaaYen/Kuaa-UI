...
const ThrowPetals = () => {
    ...
    return (
        <svg viewBox="0 39 80 20" xmlns="http://www.w3.org/2000/svg" width="4em" height="1em">
            {/* face */}
            <path 
            ...
            <motion.path 
                ...
                initial={{d: "M 7 52 q -3.148 1.259 -4.544 4.493 M 68.047 50.393 q 4.67 0.153 7.086 5.318"}}
                animate={{
                    d: [
