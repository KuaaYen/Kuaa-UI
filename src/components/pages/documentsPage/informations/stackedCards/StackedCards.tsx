...
import StackedCardsContent from './content/StackedCardsContent';
...
const StackedCards = () => {
    ...
    return (
        <motion.article
            ...
            style={{
                padding: mediaType === 'mobile' ? '6rem 0.5rem 0.5rem 0.5rem' : '8rem 2rem 2rem 2rem',
            }}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
        ...
        >
            <div className="documents-page-component-info-title">
                <span style={{ fontSize: mediaType === 'mobile' ? '3rem' : '4rem' }}>Stacked Cards</span>
                <LinkButtons
                    links={[
                        {
                            text: 'motion/react',
