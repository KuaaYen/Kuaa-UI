...
const LandingPage = () => {
    ...
    const footPrintData1 = [
        ...
        {right: '35%', top: '50%', rotate: '-130deg', stepLength: 75, color: '#52556c'},
        {right: '53%', top: '85%', rotate: '-145deg', stepLength: 120, color: '#4b4e66'},
    ...
    const mobileFootPrintData1 = [
        {right: '38%', top: '20%', rotate: '185deg', stepLength: 75, color: '#585b71'},
        {right: '42%', top: '80%', rotate: '175deg', stepLength: 95, color: '#52556c'},
    ];

    const mobileFootPrintData2 = [
        {right: '38%', top: '20%', rotate: '185deg', stepLength: 75, color: '#585b71'},
        {right: '42%', top: '50%', rotate: '175deg', stepLength: 95, color: '#52556c'},
        {right: '42%', top: '85%', rotate: '180deg', stepLength: 115, color: '#52556c'},
    ];

    const mobileFootPrintData3 = [
        {right: '38%', top: '10%', rotate: '185deg', stepLength: 80, color: '#585b71'},
        {right: '42%', top: '55%', rotate: '175deg', stepLength: 110, color: '#52556c'},
        {right: '40%', top: '110%', rotate: '175deg', stepLength: 135, color: '#52556c'},
    ];

    const tabletFootPrintData1 = [
        {right: '18%', top: '20%', rotate: '-140deg', stepLength: 70, color: '#585b71'},
        {right: '35%', top: '50%', rotate: '-130deg', stepLength: 75, color: '#52556c'},
        {right: '53%', top: '85%', rotate: '-145deg', stepLength: 110, color: '#4b4e66'},
    ];
    const tabletFootPrintData2 = [
        {right: '65%', top: '10%', rotate: '160deg', stepLength: 80, color: '#585b71'},
        {right: '54%', top: '40%', rotate: '146deg', stepLength: 100, color: '#52556c'},
        {right: '45%', top: '74%', rotate: '165deg', stepLength: 130, color: '#4b4e66'},
    ];
    const tabletFootPrintData3 = [
        {right: '38%', top: '20%', rotate: '185deg', stepLength: 80, color: '#585b71'},
        {right: '40%', top: '60%', rotate: '170deg', stepLength: 70, color: '#52556c'},
        {right: '42%', top: '105%', rotate: '180deg', stepLength: 100, color: '#52556c'},
    ];
    ...
    const getFootPrintData = ({block}: {block: number}) => {
        const footPrintMapping = {
            ...
            mobile: [mobileFootPrintData1, mobileFootPrintData2, mobileFootPrintData3]
        };
        
        return footPrintMapping[mediaType]?.[block - 1] || mobileFootPrintData1;
    }
    ...
    return (
        ...
        >
            <Helmet>
                <title>Kuaa UI — Animated React Component Library</title>
                <meta name="description" content="Kuaa UI is a collection of beautifully animated, ready-to-use React components. Copy the code, drop it in your project." />
                <link rel="canonical" href="https://kuaa-ui.vercel.app/" />
                <meta property="og:title" content="Kuaa UI — Animated React Component Library" />
                <meta property="og:description" content="Kuaa UI is a collection of beautifully animated, ready-to-use React components." />
                <meta property="og:url" content="https://kuaa-ui.vercel.app/" />
