...
const SpaceContainer = ({ containerInView }: { containerInView: boolean }) => {
    return (
        <section className="start-exploring-canvas-container">
            <motion.div 
                ...
                animate={{
                    ...
                    x: containerInView ? '200%' : '-50%',
                    y: containerInView ? '-150%' : '-50%',
                }}
                transition={{
                    type: 'spring',
                    bounce: 0,
            ...
            <motion.div 
                ...
                animate={{
                    opacity: containerInView ? 1 : 0,
                    scale: containerInView ? 1 : 0.5,
                    x: containerInView ? '-190%' : '-50%',
                    y: containerInView ? '-130%' : '-50%',
                }}
                transition={{
                    type: 'spring',
                    bounce: 0,
